...
8- Observe que no banco existe uma tabela de "especialidade" é preciso fazer uma ligação com esta tabela e a tabela de médico. -ok
                        ...
                        <div class="col-md-6">
                            ...
                            <form class="form-horizontal" id="formCadastro">
                                ...
                                <div class="row">                            
                                 ...
                                 <div class="row">                            
                                    <div class="form-group">
                                        <label for="crm" class="control-label col-sm-2" >Especialides*</label>
                                        <div class="col-sm-10">
